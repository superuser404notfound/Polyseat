...
guide() {
    ...
    printf '\n'
    printf '              The launcher needs no aiming: the D-pad moves\n'
    printf '              between icons, Y or Start opens one, B closes it.\n'
    printf '              Point at an icon and press X to pin it to the top\n'
    printf '              row, and X on a pinned one takes it off again.\n'
    printf '\n'
