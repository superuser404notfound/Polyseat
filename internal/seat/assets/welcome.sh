...
printf '\n'
printf '  Gamepad     Select+Start  turn pointer mode on and off\n'
printf '              right stick   move the pointer     A  click\n'
printf '              left stick    scroll               B  right click\n'
printf '              R3            the on-screen keyboard\n'
printf '\n'
printf '              Nothing happens until you turn pointer mode on, so a\n'
printf '              controller in a game stays a controller.\n'
printf '\n'
