...
guide() {
    ...
    printf '                                    override it by hand. The pad\n'
    printf '                                    buzzes; the override holds\n'
    printf '                                    until something goes\n'
    printf '                                    fullscreen or stops being.\n'
    printf '                                    Any two of Select, Start and\n'
    printf '                                    the Guide button will do, and\n'
    printf '                                    some clients send Guide for\n'
    printf '                                    the pair whatever you press\n'
    printf '\n'
    printf '              left stick            move the pointer\n'
    printf '              right stick           scroll\n'
    printf '              A                     left click\n'
    printf '              B                     right click\n'
    printf '              X                     Enter\n'
    printf '              Y                     Escape\n'
    printf '              LB                    Backspace\n'
    printf '              RB                    Tab\n'
